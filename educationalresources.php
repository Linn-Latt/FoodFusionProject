        ...
        <div class="container">
            ...
            <div class="ebooks">
                ...
                <div class="book">
                    ...
                    <div class="book-content">
                        <h3>Homemade Jam Recipes</h3>
                        <h5>By Harry Constantine</h5>
                        <p>
                            The less sugar you use the greater the flavor impact of the fruit.
                        </p>
                        <a href="./pdf/homemade-jam-recipes-obooko.pdf">Download Here</a>
                    </div>
                </div>
                ...
                <div class="book">
                    ...
                    <div class="book-content">
                        <h3>Fine Cooking Comfort Food</h3>
                        <h5>By The Taunton Press</h5>
                        <p>
                            200 Delicious Recipes for Soul-Warming Meals
                        </p>
                        <a href="./pdf/Fine Cooking Comfort Food 200 Delicious Recipes for Soul-Warming Meals - PDF Room.pdf">Download Here</a>
                    </div>
                </div>
            ...
            <!-- Infographic -->
            <h3 class="infographic">Infographics</h3>
            <div class="infograph">
                <div class="info">
                    <img src="./images/info01.jpg" alt="">
                    <a href="./images/info01.jpg">Download Here</a>
                </div>

                <div class="info">
                    <img src="./images/info02.jpg" alt="">
                </div>

                <div class="info">
                    <img src="./images/info03.jpg" alt="">
                </div>

                <div class="info">
                    <img src="./images/info04.jpg" alt="">
                </div>
            </div>
            <!-- Infographic End -->
